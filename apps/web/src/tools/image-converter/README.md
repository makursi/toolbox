...
- [ ] The whole flow — add, choose targets, convert, download — is usable with the keyboard alone, including opening the file dialog from the drop zone with Space or Enter.
